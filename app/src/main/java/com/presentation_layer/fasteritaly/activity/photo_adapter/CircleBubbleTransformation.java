package com.presentation_layer.fasteritaly.activity.photo_adapter;
...
public class CircleBubbleTransformation implements com.squareup.picasso.Transformation {
    ...
    public Bitmap transform(final Bitmap source) {
        ...
        paintBorder.setColor(Color.parseColor("#122280"));
        ...
        trianglePaint.setColor(Color.parseColor("#1917bb"));
